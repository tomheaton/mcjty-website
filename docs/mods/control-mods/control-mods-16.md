...
:::danger Warning
In 1.16 the `potentialspawn` system is not working properly.
It is recommended that you use the new custom spawner system!
:::
...
In most cases the first rule that matches will be executed and further rules are ignored (the rules in `potentialspawn.json` and `loot.json` are an exception to that.
...
| mindaycount / maxdaycount                                             | `I`          |                | V         | V       | V     | V      |      |            |         |           |            |       |        | indicate the minimum (inclusive) or maximum day count. The day counter starts at `0` (see the `days` command)                                                                                                                                                                                                                                                                                         |
| daycount                                                              | `I`          |                | V         | V       | V     | V      |      |            |         |           |            |       |        | this is true if the day counter is a multiple of the given parameter                                                                                                                                                                                                                                                                                                                                  |
...
| minheight / maxheight                                                 | `I`          |                | V         | V       | V     | V      | V    | V          | V       | V         | V          | V     | V      | indicates the minimum (inclusive) or maximum height at which this rule will fire                                                                                                                                                                                                                                                                                                                      |
| minlight / maxlight                                                   | `I`          |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | value between `0` and `15` indicating the minimum and maximum light level on the given block                                                                                                                                                                                                                                                                                                          |
| mincount / maxcount                                                   | `S/I/JSON`   |                | V         |         | V     | V      |      |            |         |           |            |       |        | string value that is either a number in which case it will count how many mobs of the given class are already in the world or else of the form `<amount>,<mob>` to count the number of mobs of that type. That way you can have a rule file based on the number of mobs already present. Note that instead of this syntax you can also use the JSON mob counter syntax as explained above             |
...
| minspawndist / maxspawndist                                           | `F`          |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | the minimum or maximum distance (in minecraft units) to the spawn point in the world                                                                                                                                                                                                                                                                                                                  |
| mintime / maxtime                                                     | `I`          |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | the time of the day (a number between `0` and `23999`)                                                                                                                                                                                                                                                                                                                                                |
| mindifficulty / maxdifficulty                                         | `F`          |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | the local difficulty of the place where the mob will spawn. This is a number between `0` and `4`                                                                                                                                                                                                                                                                                                      |
...
| difficulty                                                            | `S`          |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | one of the following values: easy, normal, hard, peaceful                                                                                                                                                                                                                                                                                                                                             |
| weather                                                               | `S`          |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | rain or thunder                                                                                                                                                                                                                                                                                                                                                                                       |
| category                                                              | `S/[S]`      |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | NOT for 1.19! One of the following values: none, taiga, extreme_hills, jungle, mesa, plains, savanna, icy, the_end, beach, forest, ocean, desert, river, swamp, mushroom, nether. This represents the category of the current biome                                                                                                                                                                   |
| biometags                                                             | `S/[S]`      |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | ONLY for 1.19! This is a biome tag (or list of tags) which will be used to match with the biome. Example tags are: `minecraft:is_ocean`, `minecraft:is_hill`, `minecraft:has_structure/igloo`, `minecraft:allows_surface_slime_spawns`, `forge:is_hot`, `forge:is_cold`, `forge:is_wet`, ... and a LOT more                                                                                           |
| hostile / passive                                                     | `B`          |                |           |         | V     | V      | V    | V          |         |           |            |       |        | matching only hostile or passive mobs                                                                                                                                                                                                                                                                                                                                                                 |
| seesky                                                                | `B`          |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | true if the block can see the sky (not in a cave)                                                                                                                                                                                                                                                                                                                                                     |
| slime                                                                 | `B`          |                |           |         | V     | V      |      |            |         |           |            |       |        | true if this is a slime chunk (only for 1.18 or higher)                                                                                                                                                                                                                                                                                                                                               |
| structure                                                             | `S`          |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | the name of the structure to test for. This way you can make sure a rule only fires in a village for example. Some examples are `minecraft:mineshaft`, `minecraft:village`, and so on. Modded structures should also work                                                                                                                                                                             |
...
| dimensionmod                                                          | `S/[S]`      |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | the mod of the dimension. You can use this to have a rule work in all dimensions from a given mod                                                                                                                                                                                                                                                                                                     |
| random                                                                | `F`          |                | V         |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | this will succeed rule if a random number is less then this number. So if you want to have a rule that fires with `10%`chance then use `0.1` here                                                                                                                                                                                                                                                     |
...
| amulet / ring / belt / trinket / charm / body / head                  | `S/[S]/JSON` | Baubles        |           |         | V     | V      | V    | V          | V       | V         | V          | V     | V      | check if an item is in a bauble slot (NOT IMPLEMENTED YET IN 1.16)                                                                                                                                                                                                                                                                                                                                    |
| state / pstate                                                        | `S`          | EnigmaScript   |           |         |       |        | V    | V          |         |           |            |       |        | this can be used to test the value of a (player) state with a string like this `state=value` (NOT IMPLEMENTED YET IN 1.16)                                                                                                                                                                                                                                                                            |
